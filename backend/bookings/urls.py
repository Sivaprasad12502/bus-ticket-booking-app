...
urlpatterns=[
    ...
    path('trips/<int:trip_id>/seats/',views.trip_available_seats,name='trip-available-seats'),
    path('bookings/',views.create_bookings,name='create-booking'),
    path('bookings/<int:booking_id>/passengers/',views.add_passengers,name='add-passengers'),
