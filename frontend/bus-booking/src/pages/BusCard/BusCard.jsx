      ...
      <div className="bus-results-container">
        <div className="search-info">
          ...
          <p className="route-info">
            <FaMapMarkerAlt /> {from} → {to} | {new Date(date).toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' })}
          </p>
        ...
        {data?.length === 0 ? (
          <div className="no-results">
            ...
            <button onClick={() => navigate(-1)} className="btn-search-again">Search Again</button>
          </div>
        ) : (
              ...
              <div key={trip.id} className="bus-card">
                <div className="bus-card__header">
                  <div className="bus-info">
                    ...
                    <span className={`bus-type ${trip.bus.bus_type === 'AC' ? 'ac' : 'non-ac'}`}>
                      {trip.bus.bus_type}
                    </span>
                  </div>
                ...
                <div className="bus-card__body">
                  <div className="route-details">
                    ...
                    <div className="route-line">
                      <span className="distance">{trip.route.distance_km} km</span>
                  ...
                  {trip.trip_stops && trip.trip_stops.length > 0 && (
                    <div className="stops-section">
                      <button className="view-stops-btn" onClick={(e) => {
